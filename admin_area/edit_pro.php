...
if(isset($_GET['edit_pro'])){
    ...
    $get_pro ="select * from products products where product_id='$get_id";
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <table align="center" width="795" border="2" bgcolor="#187eae">
        ...
        <tr>
            ...
            <td><input type="file" name="product_image"><img src="product_images/<?php echo $pro_image; ?>" width="60"
                height="60"/></td>
        </tr>
...
if(isset($_POST['update_product'])){
    ...
    $update_product = "update products set product_cat='product_cat',product_brand='$product_brandct',product_title=''
    '$product_title',product_price='$product_price',product_desc='$product_desc',product_image='$product_image',
    product_keyword='$product_keywords' where product_id='$update_id'";


    $ron_product = mysqli_query($con, $update_product);

    if($ron_product){
        echo "<script>alert('Product Has been updated!')</script>";
        echo "<script>window.open('insert.php?view_products','self')</script>";
    }
